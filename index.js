...
const starts = async (kurr = new WAConnection()) => {
	console.log(color('SOURCE CODE INI DIJAGA DAN DI LINDUNGI OLEH ArulGanz\n\n', 'orange'), color('\n======TERIMKASIH BANYAK KEPADA======\n•Aldy Fauzy\n•Kemol\n•ADI\n•ArulGanz\n•YUDHA\n•PAJARn•Dcode Denpa\n•Finx\n•SELURUH Followersku', 'yellow'))
	console.log(color('\n\nJANGAN DI JUAL  BRO😑\nKALAU ADA YG JUAL SURUH CHAT ©ArulGanz\nWA 6281229859085', 'pink'))
    kurr.logger.level = 'warn'
    kurr.version = [2, 2143, 3]
    kurr.browserDescription = [ 'ArulGanz', 'Chrome', '3.0' ]
    ...
    kurr.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6281229859085@s.whatsapp.net","6281229859085@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
       ...
       otod = `${settings.NomorOwner}@s.whatsapp.net`
        ...
        kurr.on('group-participants-update', async (anu) => {
           mem = anu.participants[0]
			...
			gbutsan = [{buttonId:'allmenu',buttonText:{displayText:'AllMenu'},type:1}, {buttonId:'command',buttonText:{displayText:'ListMenu'},type:1}]
...
contentText: `${masuk}`,
footerText: `Welcome  By ArulGanz`, 
buttons: gbutsan,
headerType: 4 }
...
kurr.on('CB:action,,call', async json => {
        ...
        kurr.sendMessage(callerId, { displayname: `${NamaOwner}`, vcard: vcard}, MessageType.contact, {contextInfo: { externalAdReply:{title: `Developer ${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./thumb.jpg'),sourceUrl:`https://wa.me/6281229859085?text=Assalamualaikum`}}})
        await sleep(5000)
